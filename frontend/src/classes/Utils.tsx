...
export async function sendSubscribe(email:string, difficulty:string) {
...
export function standardifyStringSession(mtx: any) {
...
export const transferTable = (stringTable: string, table: any) => {
